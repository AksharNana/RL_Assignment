...
class Gym2OpEnv(gym.Env):
    ...
    def setup_observations(self):
        ...
        size = self._gym_env.observation_space
        ...
        for i, attr in enumerate(self.obs_attr_to_keep):
            n_bins = bin_counts[i]
    ...
    def discretise_observation(self, obs, reset = True):
        ...
        if reset:
            ...
            for attr in self.obs_attr_to_keep:
                ...
                # low = self._gym_env.observation_space.low[self.obs_indices[attr]]
                # high = self._gym_env.observation_space.high[self.obs_indices[attr]]
                # print(f"Attribute: {attr}, Dimension: {dim}, Low: {low}, High: {high}")
